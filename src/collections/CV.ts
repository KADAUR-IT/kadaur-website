      ...
      handler: async (req) => {
        ...
        if (data.skill) {
          ...
          for (let index = 0; index < skillsInput.length; index++) {
            skillsList.push({
              skillLabel: skillsInput[index],
              skillCategory: skillsCategoryInput[index],
            })
          }
        }
        ...
        if (data.formationName) {
          ...
          for (let index = 0; index < formationNamesInput.length; index++) {
            formationsList.push({
              formationName: formationNamesInput[index],
              formationOrganism: formationOrganismsInput[index],
              formationDateStart: formationStartInput[index],
              formationDateEnd: formationEndInput[index],
            })
          }
        }
        ...
        if (data.language) {
          ...
          for (let index = 0; index < languagesInput.length; index++) {
            languagesList.push({
              languageName: languagesInput[index],
              languangeLevel: languagesLevelInput[index],
            })
          }
        }
        ...
        if (data.jobTitle) {
          ...
          for (let index = 0; index < jobTitlesInput.length; index++) {
            experiencesList.push({
              jobTitle: jobTitlesInput[index],
              jobEntreprise: jobEntreprisesInput[index],
              jobDateStart: jobStartInput[index],
              jobDateEnd: jobEndInput[index],
              jobDescription: jobDescriptionsInput[index],
            })
          }
        }
